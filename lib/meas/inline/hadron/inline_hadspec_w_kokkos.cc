...
#include "meas/hadron/mesons2_w_kokkos.h"
#include "meas/hadron/barhqlq_w_kokkos.h"
#include "meas/hadron/curcor2_w_kokkos.h"
		      ...
		      XMLWriter& xml_out) 
  {
	...
	QDP_abort(1);
     ...
     tClock.start();
      ...
      void *raw_qdp_jit_pointer2 = QDP_get_global_cache().get_dev_ptr( sink_prop_2.getId() );
      QDPViewType view_of_sink_prop_2(  (FType *) raw_qdp_jit_pointer2, numSites );
