...
#ifndef __unprec_wilstype_fermact_4q_w_h__
#define __unprec_wilstype_fermact_4q_w_h__
...
namespace Chroma
{
  ...
  class UnprecWilsonTypeFermAct4Q : public WilsonTypeFermAct4Q<T,P,Q>
  {
  public:
    //! Virtual destructor to help with cleanup;
    virtual ~UnprecWilsonTypeFermAct4Q() {}
   ...
   */
  template<typename T, typename P, typename Q>
  class UnprecWilsonTypeFermAct5D4Q : public WilsonTypeFermAct5D4Q<T,P,Q>
  {
  public:
    //! Virtual destructor to help with cleanup;
    virtual ~UnprecWilsonTypeFermAct5D4Q() {}
