...
/*! @file
 * @brief Wilson-like 2quark fermion actions
 * Dirac operator for Regular fermion actions act like D F =S
 * This fermion action acts like
 * (D  0)  (F_1) = (S_1)
 * (0  D) (F_2)   (S_2)
 *
 */

#ifndef __wilstype_fermact_2qblock_w_h__
#define __wilstype_fermact_2qblock_w_h__
...
namespace Chroma
{
  ...
  class WilsonTypeFermAct2QB : public DiffFermAct4D<T,P,Q>
  {
  public:
    //! Virtual destructor to help with cleanup;
    virtual ~WilsonTypeFermAct2QB() {}
   ...
   */
  template<typename T, typename P, typename Q>
  class WilsonTypeFermAct5D2QB : public DiffFermAct5D<T,P,Q>
  {
  public:
    //! Virtual destructor to help with cleanup;
    virtual ~WilsonTypeFermAct5D2QB() {}
