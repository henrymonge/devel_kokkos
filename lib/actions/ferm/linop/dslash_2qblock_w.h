...
#ifndef DSLASH_2QB_W_H
#define DSLASH_2QB_W_H
...
namespace Chroma {
  ...
  typedef QDPWilson2QBDslash WilsonDslash;
  typedef QDPWilson2QBDslashF WilsonDslashF;
  typedef QDPWilson2QBDslashD WilsonDslashD;
