...
#ifndef __lwldslash_base_2qblock_h__
#define __lwldslash_base_2qblock_h__
...
{ 
  ...
  template<>
  class HalfFermionType<LatticePropagatorF>  { 
  public:
    typedef LatticeHalfFermionF Type_t;
  };

  template<>
  class HalfFermionType<LatticePropagatorD>  { 
  public:
...
#warning "Derivative not implemented for 2QB Wilson Fermion Action" 
 ...
 class WilsonDslashBaseF : 
    public DslashLinearOperator<LatticePropagatorF,
				multi1d<LatticeColorMatrixF>,
				multi1d<LatticeColorMatrixF> >
  {
  public:
    typedef LatticePropagatorF T;
