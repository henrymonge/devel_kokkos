...
namespace Chroma
{
   ...
   */
  void UnprecExpCloverLinOp::create(Handle<FermState<T, P, Q>> fs,
   ...
   */
  void UnprecExpCloverLinOp::operator()(LatticeFermion& chi, const LatticeFermion& psi,
  ...
  void UnprecExpCloverLinOp::deriv(multi1d<LatticeColorMatrix>& ds_u, const LatticeFermion& chi,
				   const LatticeFermion& psi, enum PlusMinus isign) const
  {
    // A. deriv will resize
  ...
  unsigned long UnprecExpCloverLinOp::nFlops() const
  {
