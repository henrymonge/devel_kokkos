...
{ 
   ...
   */
  void UnprecClover2QBLinOp::create(Handle< FermState<T,P,Q> > fs,
   ...
   */
  void UnprecClover2QBLinOp::operator()(LatticePropagator & chi, 
  ...
  void 
  UnprecClover2QBLinOp::deriv(multi1d<LatticeColorMatrix>& ds_u,
  ...
  unsigned long UnprecClover2QBLinOp::nFlops() const
  {
