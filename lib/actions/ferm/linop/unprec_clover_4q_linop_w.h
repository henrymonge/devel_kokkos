...
#ifndef __unprec_clover_linop_4q_w_h__
#define __unprec_clover_linop_4q_w_h__

#include "linearop.h"
#include "actions/ferm/linop/dslash_4q_w.h"
#include "actions/ferm/linop/clover_4q_term_w.h"
...
{ 
  ...
  class UnprecClover4QLinOp : public UnprecLinearOperator<LatticePropagator, 
  ...
  public:
    ...
    //! Full constructor
    UnprecClover4QLinOp(Handle< FermState<T,P,Q> > fs,
