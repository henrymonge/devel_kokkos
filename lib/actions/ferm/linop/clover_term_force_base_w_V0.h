...
{ 
  ...
  public:
    ...
    //I don't believe we need and applySite, I only want the force functionality
     ...
     */
    //All the classes will have a derivative, I will need a base derivative as well
...
#undef _elem
   ...
   */
  template<typename T, typename U>
  void CloverTermForceBase<T,U>::derivTrLn(multi1d<U>& ds_u, 
				 enum PlusMinus isign, int cb) const
  {
    START_CODE();
