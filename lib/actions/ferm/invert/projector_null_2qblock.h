...
namespace Chroma
{
   ...
   */
  template<typename T>
  class ProjectorNull2QB : public Projector<T>
  {
  public:
     ...
     */
    ProjectorNull2QB(Handle<LinearOperator<T>> A_) : A(A_)
    {
    }
	...
	*psi[i] = zero;
    ...
    {
      throw std::runtime_error("ProjectorNull2QB: rank of the projector is null");
    }
  ...
  namespace ProjectorNull2QBEnv
  {
    ...
    {
      return new ProjectorNull2QB<LatticePropagator>(A);
    }
    ...
    inline bool registerAll() {
      ...
      registered = true;
      return Chroma::TheLinOpFerm2QBProjectorFactory::Instance().registerObject("NULL_PROJECTOR_2QB",
									     createProjector);
    }
  }
} // End namespace
